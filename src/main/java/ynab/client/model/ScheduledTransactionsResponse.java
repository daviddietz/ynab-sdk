...
import ynab.client.model.ScheduledTransactionsWrapper;
...
public class ScheduledTransactionsResponse {
  @SerializedName("data")
  private ScheduledTransactionsWrapper data = null;

  public ScheduledTransactionsResponse data(ScheduledTransactionsWrapper data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ScheduledTransactionsWrapper getData() {
    return data;
  }

  public void setData(ScheduledTransactionsWrapper data) {
    this.data = data;
  }
