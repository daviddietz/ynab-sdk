...
import ynab.client.model.PayeesWrapper;
...
public class PayeesResponse {
  @SerializedName("data")
  private PayeesWrapper data = null;

  public PayeesResponse data(PayeesWrapper data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public PayeesWrapper getData() {
    return data;
  }

  public void setData(PayeesWrapper data) {
    this.data = data;
  }
