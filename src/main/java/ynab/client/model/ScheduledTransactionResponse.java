...
import ynab.client.model.ScheduledTransactionWrapper;
...
public class ScheduledTransactionResponse {
  @SerializedName("data")
  private ScheduledTransactionWrapper data = null;

  public ScheduledTransactionResponse data(ScheduledTransactionWrapper data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ScheduledTransactionWrapper getData() {
    return data;
  }

  public void setData(ScheduledTransactionWrapper data) {
    this.data = data;
  }
